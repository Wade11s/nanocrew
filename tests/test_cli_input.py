...
from nanocrew.cli import commands
...
def mock_prompt_session():
    ...
    with patch("nanocrew.cli.commands._PROMPT_SESSION", mock_session), \
         patch("nanocrew.cli.commands.patch_stdout"):
        yield mock_session
...
def test_init_prompt_session_creates_session():
    ...
    with patch("nanocrew.cli.commands.PromptSession") as MockSession, \
         patch("nanocrew.cli.commands.FileHistory") as MockHistory, \
