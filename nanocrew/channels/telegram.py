...
from nanocrew.config.schema import TelegramConfig
...
class TelegramChannel(BaseChannel):
    ...
    def __init__(
        ...
        self._agent_manager = agent_manager  # chat_id -> typing loop task
    ...
    async def _on_message(self, update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
        ...
        if media_file and self._app:
            try:
                ...
                media_dir = Path.home() / ".nanocrew" / "media"
                ...
                if media_type == "voice" or media_type == "audio":
                    from nanocrew.providers.transcription import GroqTranscriptionProvider
        ...
        if self._agent_manager:
            ...
            logger.info(f"Telegram: Session {session_key} -> Agent '{agent_name}'")
